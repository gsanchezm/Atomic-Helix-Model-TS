---
source_file: "ISTQB_CTFL_Syllabus_v4.0.1.pdf"
source_path: "input/ISTQB_CTFL_Syllabus_v4.0.1.pdf"
conversion_profile: "digital_pdf_llm"
converter: "pymupdf4llm"
generated_at_utc: "2026-06-28T22:46:03Z"
---
...
|ASQF V2.2|07.2003|ASQF Syllabus Foundation Level Version v2.2 “Lehrplan Grundlagen<br>des Software-testens“|
...
- FL-BO10 Work as part of a cross-functional team FL-BO11 Know risks and benefits related to test automation

- FL-BO12 Identify essential skills required for testing

- FL-BO13 Understand the impact of risk on testing FL-BO14 Effectively report on test progress and quality
...
## **1. Fundamentals of Testin – 180 minutes g**
...
- natural language, which is easy to understand by stakeholders usually using the Given/When/Then format (Chelimsky 2010)
...
**White-box testing** (see section 4.3) is structure-based and derives tests from the system's implementation or internal structure (e.g., code, architecture, work ~~f~~ lows, and data flows). The main objective of white-box testing is to cover the underlying structure by the tests to an acceptable level.
...
Work products that are not appropriate for static testing include those that are difficult to interpret by human beings and that should not be analyzed by tools (e.g., 3[rd] party executable code due to legal reasons).
...
## **4. Test Anal sis and Desi n – 390 minutes y g**
...
Hetzel, B. (1988) The Complete Guide to Software Testing, 2[nd] ed., John Wiley and Sons
...
Kaner, C., Falk, J., and Nguyen, H.Q. (1999) Testing Computer Software, 2[nd] ed., Wiley
...
Brykczynski, B. (1999) “A survey of software inspection checklists,” _ACM SIGSOFT Software Engineering Notes, 24(1), pp. 82-89_

Page 62 of 78

© International Software Testing Qualifications Board

Enders, A. (1975) “An Analysis of Errors and Their Causes in System Programs,” _IEEE Transactions on Software Engineering 1(2), pp. 140-149_

Manna, Z., Waldinger, R. (1978) “The logic of computer programming,” _IEEE Transactions on Software Engineering 4(3), pp. 199-229_

Marick, B. (2003) Exploration through Example, http://www.exampler.com/oldblog/2003/08/21.1.html#agile-testing-project-1

Nielsen, J. (1994) “Enhancing the explanatory power of usability heuristics,” _Proceedings of the SIGCHI Conference on Human Factors in Computing Systems: Celebrating Interdependence, ACM Press, pp. 152–158_

Salman. I. (2016) “Cognitive biases in software quality and testing,” _Proceedings of the 38th International Conference on Software Engineering Companion (ICSE '16), ACM, pp. 823-826._

Wake, B. (2003) “INVEST in Good Stories, and SMART Tasks _,”_ https://xp123.com/articles/invest-in-goodstories-and-smart-tasks/
...
|Business Outcomes: Foundation Level|Business Outcomes: Foundation Level|FL-BO1|FL-BO2|FL-BO3|FL-BO4|FL-BO5|FL-BO6|FL-BO7|FL-BO8|FL-BO9|FL-BO10|FL-BO11|FL-BO12|FL-BO13|FL-BO14|
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
|BO1|Understand what testing is and why it is beneficial|6||||||||||||||
|BO2|Understand fundamental concepts of software testing||22|||||||||||||
|BO3|Identify the test approach and activities to be implemented depending on<br>the context of testing|||6||||||||||||
...
|BO9|Understand the factors that influence the priorities and efforts related to<br>testing|||||||||7||||||
...
|Chapter/<br>section/<br>subsection|Learning objective|K-<br>level|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|BUSINESS OUTCOMES|
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
|3.2.3|Recall which responsibilities are assigned to the principal roles when performing<br>reviews|K1||||X||||||||X|||
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
||||FL-BO1|FL-BO2|FL-BO3|FL-BO4|FL-BO5|FL-BO6|FL-BO7|FL-BO8|FL-BO9|FL-BO10|FL-BO11|FL-BO12|FL-BO13|FL-BO14|
|4.1.1|Distinguish black-box test techniques, white-box test techniques and experience-<br>based test techniques|K2||X|||||||||||||
|**4.2**|**Black-box Test Techniques**||||||||||||||||
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
||||FL-BO1|FL-BO2|FL-BO3|FL-BO4|FL-BO5|FL-BO6|FL-BO7|FL-BO8|FL-BO9|FL-BO10|FL-BO11|FL-BO12|FL-BO13|FL-BO14|
|4.5.1|Explain how to write user stories in collaboration with developers and business<br>representatives|K2||||X||||||X|||||
...
|5.1.7|Summarize the testing quadrants and their relationships with test levels and test types|<br>K2||X|||||||X||||||
|**5.2**|**Risk Management**||||||||||||||||
