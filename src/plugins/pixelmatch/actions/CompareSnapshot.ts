...
import { parseVisualTarget } from '@plugins/pixelmatch/actions/visual-target-options';
...
import {
    ...
    ensureDir,
    VisualPathKey,
} from '@plugins/pixelmatch/support/visual-paths';
import { resolveScreenshotSource } from '@plugins/pixelmatch/support/screenshot-source-factory';
import {
    baselineExists,
    isUpdateBaselineEnv,
    resolveThresholds,
    writeBaselineFromBuffer,
} from '@plugins/pixelmatch/support/visual-baseline-policy';
import { comparePngBuffers } from '@plugins/pixelmatch/support/visual-image-utils';
import { emitVisualTelemetry } from '@plugins/pixelmatch/support/visual-telemetry';
import { VisualComparisonResult } from '@plugins/pixelmatch/support/visual-result.types';

export const CompareSnapshotAction: ActionHandler<PixelmatchActionContext> = {
